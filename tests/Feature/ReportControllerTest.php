...
class ReportControllerTest extends TestCase
{
    ...
    public function test_creating_report_sends_telegram_notification_with_creator_name(): void
    {
        ...
        $payload = [
            ...
            'bloggerPageLink' => 'https://t.me/some_influencer',
            'platform' => 'Telegram',
            'slotsCount' => 5,
            'paidSlotsCount' => 2,
            'pricePerSlot' => 100.00,
    ...
    public function test_creating_report_sends_telegram_notification_with_fallback_email_if_not_found(): void
    {
        ...
        $payload = [
            ...
            'bloggerPageLink' => 'https://instagram.com/another_influencer',
            'platform' => 'Instagram',
            'slotsCount' => 10,
            'paidSlotsCount' => 10,
            'pricePerSlot' => 500.00,
    ...
    public function test_deleting_last_report_deletes_integration(): void
    {
        ...
        $payload = [
            ...
            'bloggerPageLink' => 'https://t.me/blogger_to_delete',
            'platform' => 'Telegram',
            'slotsCount' => 5,
            'paidSlotsCount' => 2,
            'pricePerSlot' => 100.00,
    ...
    public function test_deleting_report_recalculates_integration(): void
    {
        ...
        $payload1 = [
            ...
            'bloggerPageLink' => 'https://t.me/blogger_to_keep',
            'platform' => 'Telegram',
            'slotsCount' => 5,
            'paidSlotsCount' => 2,
            'pricePerSlot' => 100.00,
    ...
    public function test_creating_multi_project_bulk_report_allocates_integrations_per_project(): void
    {
        ...
        $payload = [
            ...
            'bloggerPageLink' => 'https://t.me/bulk_blogger',
            'platform' => 'Telegram',
            'slotsCount' => 5,
            'paidSlotsCount' => 5,
